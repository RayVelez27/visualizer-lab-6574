...
Requires objects from Figure 4C 
``` {r}
# Knitting Figure 4 document to load data
knit_dir = ".knitR"
if (!dir.exists(knit_dir)) { dir.create(knit_dir, recursive = TRUE) }
  knit_Figure4 = paste0(knit_dir, "/Figure4.R")
  if (!file.exists(knit_Figure4)) {
      knitr::purl(
      input = "Figure4_pt2.Rmd",
      output = knit_Figure4,
      documentation = 1
    )
}
